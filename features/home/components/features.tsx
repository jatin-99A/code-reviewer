...
const features = [
  {
    ...
    description: "AI reviews your pull requests in seconds with deep context understanding. Get actionable feedback without the wait.",
    gradient: "from-amber-500 to-orange-500",
  },
  {
    icon: Shield,
    title: "Security First",
    description: "Detect vulnerabilities before they hit production. AI-powered security scanning integrated into your workflow.",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    icon: Gauge,
    title: "Blazing Fast",
    description: "Optimized AI pipeline for near real-time feedback. Get reviews faster than any human could provide.",
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    icon: Lightbulb,
    title: "Code Insights",
    description: "Performance and structure suggestions powered by AI. Learn and improve with every pull request.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <CardContent className="relative z-10 p-8 md:p-10">
                <div className="flex items-start gap-6">
                  {/* Icon */}
                  <div className={`shrink-0 w-16 h-16 rounded-2xl bg-linear-to-br ${feature.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            >
              <div className="shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-blue-500 to-emerald-500 flex items-center justify-center">
